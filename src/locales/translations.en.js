...
export const CODINGJR_TRANSLATIONS_EN = {
  controls: {
    run: "Run",
    stop: "Stop",
  },
  welcomeScreen: {
    logoPlaceholder: "PLACE YOUR LOGO ",
    title: "Welcome to the Lab",
    subtitle: "Learn logical thinking and programming with fun challenges.",
    guides: "GUIDES",
    myTracks: "MY TRACKS",
    start: "START LAB SESSION",
    toggleAudio: "Toggle Audio",
    help: "Guides",
    achievements: "My Tracks",
    language: "Language",
    settings: "Settings",
    theme: "Theme",
  },
  ...
  helpScreen: {
    ...
    walkForward: {
      ...
      content:
        "When walking forward, the robot will advance one square in the direction it is currently facing. This movement will only be performed if the space it would be heading into is of the same height as the square it is moving out from. In any other case the movement will not be performed.",
    },
    turnRight: {
      title: "Instruction: Turn 90 degrees to the right",
      content:
        "When turning 90 degrees to the right, the robot will stay in place and turn 90 degrees (a quarter turn) to the right (clockwise).",
    },
    turnLeft: {
      title: "Instruction: Turn 90 degrees to the left",
      content:
        "When turning 90 degrees to the left, the robot will stay in place and turn 90 degrees (a quarter turn) to the left (anti-clockwise).",
    },
    jump: {
  ...
  dialogs: {
    levelComplete: {
      ...
      message:
        "Congratulations! You have completed this level using {{count}} instructions!",
      bronzeMedalHint:
        "Complete the level with {{count}} instructions or less to receive a bronze medal.",
      silverMedalHint:
        "Complete the level with {{count}} instructions or less to receive a silver medal.",
      goldMedalHint:
        "Complete the level with {{count}} instructions or less to receive a gold medal.",
    },
    achievement: {
